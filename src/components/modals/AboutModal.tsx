...
export const AboutModal: React.FC<Props> = ({ isOpen, onClose }) => {
  ...
  return (
    <div className="fixed inset-0 z-50 flex items-center justify-center p-4 bg-black/70 backdrop-blur-sm overflow-y-auto animate-in fade-in duration-200">
      <div className="bg-white rounded-3xl shadow-2xl border border-[#e8e3d8] max-w-3xl w-full my-8 overflow-hidden">
        
        {/* Modal Header */}
        <div className="bg-[#385529] text-white border-b-4 border-[#a16b15] px-6 py-5 flex items-center justify-between">
          <div className="flex items-center space-x-3">
            ...
            />
            <div>
              <h3 className="font-serif font-bold text-lg leading-tight uppercase tracking-wide text-[#fdf8f0]">
          ...
          <button
            onClick={onClose}
            className="p-1.5 rounded-xl hover:bg-[#273e1c] text-[#e2ebd9] hover:text-white transition-colors"
          >
            <X className="w-5 h-5" />
          </button>
        </div>
        ...
        {/* Content Body */}
        <div className="p-6 space-y-6 max-h-[75vh] overflow-y-auto text-xs text-gray-700 leading-relaxed">
          
          {/* Overview Banner */}
          <div className="bg-[#faf9f5] border border-[#e8e3d8] rounded-2xl p-4 space-y-2">
            <h4 className="font-serif font-bold text-sm text-[#385529] flex items-center gap-1.5">
            ...
            <div className="grid grid-cols-1 sm:grid-cols-2 gap-2.5 pt-1">
              <div className="p-3 bg-white rounded-xl border border-[#e8e3d8] shadow-2xs">
                <span className="text-[10px] font-bold uppercase text-[#385529] tracking-wider block">
                  4-Year Regular B.E. / B.Tech
                </span>
                <span className="text-lg font-serif font-black text-[#385529]">
                  60 Points Target
                </span>
                <p className="text-[11px] text-gray-500 mt-0.5">Across Semesters I to VIII</p>
              </div>
              <div className="p-3 bg-white rounded-xl border border-[#e8e3d8] shadow-2xs">
                <span className="text-[10px] font-bold uppercase text-[#a16b15] tracking-wider block">
                  Diploma Lateral Entry (LE)
                </span>
                <span className="text-lg font-serif font-black text-[#a16b15]">
                  50 Points Target
                </span>
                <p className="text-[11px] text-gray-500 mt-0.5">Across Semesters III to VIII</p>
              </div>
            </div>
          </div>
          ...
          <div className="space-y-3">
            <h4 className="font-serif font-bold text-sm text-[#385529] flex items-center gap-1.5 border-b border-[#e8e3d8] pb-2">
              <Sparkles className="w-4 h-4 text-[#a16b15]" />
              <span>How to Upload & Track Activity Points (3-Step Guide)</span>
            </h4>

            <div className="space-y-2.5">
              <div className="flex items-start gap-3 p-3 rounded-xl bg-white border border-[#e8e3d8]">
                ...
                <div>
                  <h5 className="font-bold text-[#1c2718]">Snap / Upload Certificate</h5>
              ...
              <div className="flex items-start gap-3 p-3 rounded-xl bg-white border border-[#e8e3d8]">
                ...
                <div>
                  <h5 className="font-bold text-[#1c2718]">Mentor Approval & 1-Click PDF Sheet</h5>
                  <p className="text-[11px] text-gray-600 mt-0.5">
          ...
          <div className="p-4 rounded-2xl bg-[#eef5ec] border border-[#385529]/30 space-y-2">
            <h4 className="font-serif font-bold text-xs uppercase tracking-wider text-[#385529]">
              Academic Project Attribution
            </h4>
            <p className="text-[11px] text-[#273e1c]">
        ...
        {/* Modal Footer */}
        <div className="bg-[#faf9f5] border-t border-[#e8e3d8] px-6 py-3.5 flex flex-col sm:flex-row sm:items-center justify-between gap-2">
          <a
            href="https://github.com/saleemshaik2005/CBIT-Activity-Points"
            target="_blank"
            rel="noreferrer"
            className="inline-flex items-center gap-1.5 text-xs font-bold text-[#385529] hover:text-[#a71a1b]"
          >
          ...
          <button
            onClick={onClose}
            className="px-5 py-2 bg-[#385529] hover:bg-[#273e1c] text-white font-bold text-xs rounded-xl shadow-xs transition-all"
          >
            Close Guide
          </button>
        </div>
