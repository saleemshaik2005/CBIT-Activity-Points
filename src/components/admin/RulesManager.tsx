...
export const RulesManager: React.FC = () => {
  ...
  return (
    <div className="space-y-6">
      ...
      <div className="bg-white dark:bg-[#161e2e] rounded-2xl p-6 border-t-4 border-[#385529] dark:border-emerald-500 border-x border-b border-[#e8e3d8] dark:border-[#293548] shadow-xs space-y-4">
        <div className="flex items-center space-x-2">
          <Settings className="w-5 h-5 text-[#385529] dark:text-emerald-400" />
        ...
        <form onSubmit={handleSaveSettings} className="grid grid-cols-1 sm:grid-cols-3 gap-4 pt-2">
          <div>
            ...
            <input
              ...
              className="w-full px-3 py-2 text-sm font-bold text-[#385529] dark:text-white rounded-xl border border-[#e8e3d8] dark:border-[#334155] bg-gray-50 dark:bg-[#0f172a] focus:ring-2 focus:ring-[#385529] dark:focus:ring-emerald-500 focus:outline-none"
            />
          </div>
          ...
          <div>
            ...
            <input
              ...
              className="w-full px-3 py-2 text-sm font-bold text-[#a16b15] dark:text-amber-400 rounded-xl border border-[#e8e3d8] dark:border-[#334155] bg-gray-50 dark:bg-[#0f172a] focus:ring-2 focus:ring-[#a16b15] dark:focus:ring-amber-500 focus:outline-none"
            />
          </div>
          ...
          <div className="flex items-end space-x-2">
            <button
              type="submit"
              className="w-full px-4 py-2.5 bg-[#385529] hover:bg-[#273e1c] dark:bg-emerald-600 dark:hover:bg-emerald-500 text-white text-xs font-bold rounded-xl shadow-xs transition-all flex items-center justify-center space-x-1.5 cursor-pointer"
            >
            ...
            <button
              ...
              className="p-2.5 border border-[#e8e3d8] dark:border-[#334155] hover:bg-gray-50 dark:hover:bg-[#1e293b] text-gray-600 dark:text-gray-300 rounded-xl transition-colors cursor-pointer"
            >
      ...
      <div className="bg-white dark:bg-[#161e2e] rounded-2xl p-6 border border-[#e8e3d8] dark:border-[#293548] shadow-xs space-y-4">
        <div>
          <h3 className="text-base font-serif font-bold text-[#385529] dark:text-emerald-400 uppercase tracking-wide">
        ...
        <div className="overflow-x-auto">
          <table className="w-full text-left text-xs">
            <thead className="bg-[#faf9f5] dark:bg-[#0f172a] border-y border-[#e8e3d8] dark:border-[#293548] text-[#385529] dark:text-gray-200 font-serif font-bold uppercase tracking-wider">
              <tr>
            ...
            <tbody className="divide-y divide-gray-100 dark:divide-[#293548]">
              {categories.map((cat) => {
                const isEditingThis = editingCategory?.id === cat.id;

                if (isEditingThis && editingCategory) {
                  return (
                    <tr key={cat.id} className="bg-amber-50/60 dark:bg-amber-950/20">
                      ...
                      <td className="py-3 px-4">
                        <input
                          ...
                          className="w-full text-xs p-1.5 border rounded-lg bg-white dark:bg-[#0f172a] text-gray-900 dark:text-white border-gray-300 dark:border-[#334155]"
                        />
                      </td>
                      ...
                      <td className="py-3 px-3 text-center">
                        <input
                          ...
                          className="w-16 text-xs p-1.5 border rounded-lg bg-white dark:bg-[#0f172a] text-gray-900 dark:text-white border-gray-300 dark:border-[#334155] text-center font-bold"
                        />
                      </td>
                      <td className="py-3 px-3 text-center">
                        <input
                      ...
                      <td className="py-3 px-3 text-right space-x-1">
                        ...
                        <button
                          ...
                          className="p-1.5 bg-gray-200 dark:bg-gray-700 text-gray-700 dark:text-gray-300 rounded-lg hover:opacity-90 cursor-pointer"
                        >
                ...
                return (
                  <tr key={cat.id} className="hover:bg-[#faf9f5] dark:hover:bg-[#1e293b]/60 transition-colors">
                    <td className="py-3 px-3 text-center font-bold text-[#385529] dark:text-emerald-400">#{cat.sno}</td>
                    <td className="py-3 px-4 font-semibold text-gray-900 dark:text-white">{cat.name}</td>
                    <td className="py-3 px-3 text-gray-600 dark:text-gray-300">
                      <span className="bg-[#faf9f5] dark:bg-[#0f172a] px-2 py-0.5 rounded-md text-[11px] border border-[#e8e3d8] dark:border-[#334155]">
                        {cat.sub_type || 'General'}
                      </span>
                    </td>
                    <td className="py-3 px-3 text-center font-extrabold text-[#385529] dark:text-emerald-400">
                    ...
                    <td className="py-3 px-3 text-right">
                      <button
                        ...
                        className="px-2.5 py-1 text-[11px] font-bold text-[#a16b15] dark:text-amber-400 hover:text-[#385529] dark:hover:text-emerald-300 hover:bg-[#fbf5eb] dark:hover:bg-[#1e293b] rounded-lg transition-colors cursor-pointer"
                      >
                        Edit Rule
                      </button>
                    </td>
