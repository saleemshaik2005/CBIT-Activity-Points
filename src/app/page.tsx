      ...
      <section className="text-center space-y-5 max-w-3xl mx-auto pt-4">
        ...
        <div className="flex flex-wrap items-center justify-center gap-3 pt-2">
          {isAuthenticated ? (
            <>
              <button
                ...
                className="px-6 py-3 bg-[#385529] hover:bg-[#273e1c] dark:bg-emerald-600 dark:hover:bg-emerald-500 text-white font-bold text-sm rounded-xl shadow-md hover:shadow-lg transition-all flex items-center space-x-2 border-b-2 border-[#a16b15] dark:border-emerald-700 cursor-pointer"
              >
                <span>Open Student Dashboard</span>
                <ArrowRight className="w-4 h-4 text-[#dfa94b] dark:text-white" />
              </button>
            ...
            <>
              <Link
                href="/login"
                className="px-6 py-3 bg-[#385529] hover:bg-[#273e1c] dark:bg-emerald-600 dark:hover:bg-emerald-500 text-white font-bold text-sm rounded-xl shadow-md hover:shadow-lg transition-all flex items-center space-x-2 border-b-2 border-[#a16b15] dark:border-emerald-700"
              >
                <LogIn className="w-4 h-4 text-[#dfa94b] dark:text-white" />
                <span>Sign In to Portal</span>
              </Link>

              <Link
                href="/register"
                className="px-6 py-3 bg-white dark:bg-[#22232a] hover:bg-[#faf7f2] dark:hover:bg-[#2a2b33] text-[#385529] dark:text-gray-200 font-bold text-sm rounded-xl border border-[#e8e3d8] dark:border-[#2e3039] shadow-xs hover:shadow transition-all flex items-center space-x-2"
              >
                <span>Create Student Account</span>
                <ArrowRight className="w-4 h-4 text-[#a16b15] dark:text-amber-400" />
              </Link>
            </>
          )}
          ...
          <button
            ...
            className="px-5 py-3 bg-[#fbf5eb] dark:bg-[#1a1b20] hover:bg-[#f5e9d3] dark:hover:bg-[#22232a] text-[#a16b15] dark:text-gray-300 font-bold text-sm rounded-xl border border-[#a16b15]/40 dark:border-[#2c2d36] shadow-xs hover:shadow transition-all flex items-center space-x-2 cursor-pointer"
          >
            <HelpCircle className="w-4 h-4 text-[#a16b15] dark:text-amber-400" />
