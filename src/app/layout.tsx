...
export default function RootLayout({
  ...
  return (
    <html lang="en">
      <body className="min-h-screen bg-[#faf9f5] dark:bg-[#0b0f17] text-[#1c2718] dark:text-[#f8fafc] flex flex-col antialiased selection:bg-[#385529] dark:selection:bg-emerald-600 selection:text-white transition-colors">
        <AppProvider>
          <Navbar />
