...
export default function MentorMenteesPage() {
  ...
  return (
    <div className="space-y-6">
      ...
      <div className="flex flex-col sm:flex-row sm:items-center justify-between gap-4 bg-white dark:bg-[#151f12] rounded-2xl p-6 border-t-4 border-[#a16b15] dark:border-[#fbbf24] border-x border-b border-[#e8e3d8] dark:border-[#2b3d26] shadow-xs">
        ...
        <div className="flex items-center space-x-2">
          ...
          <select
            ...
            className="px-3 py-1.5 text-xs rounded-xl border border-gray-300 dark:border-[#2b3d26] bg-white dark:bg-[#1a2817] text-gray-900 dark:text-white focus:outline-none focus:ring-2 focus:ring-[#385529]"
          >
      ...
      <div className="bg-white dark:bg-[#151f12] rounded-2xl border border-[#e8e3d8] dark:border-[#2b3d26] shadow-xs overflow-hidden">
        <div className="overflow-x-auto">
          <table className="w-full text-left text-xs">
            <thead className="bg-[#faf9f5] dark:bg-[#1a2817] border-b border-[#e8e3d8] dark:border-[#2b3d26] text-[#385529] dark:text-[#4ade80] font-serif font-bold uppercase tracking-wider">
              <tr>
            ...
            <tbody className="divide-y divide-gray-100 dark:divide-[#2b3d26]">
              {filteredMentees.map((mentee) => {
                ...
                return (
                  <tr key={mentee.id} className="hover:bg-[#faf9f5] dark:hover:bg-[#1a2817] transition-colors">
                    ...
                    <td className="py-3.5 px-3">
                      <span className={`px-2 py-0.5 rounded text-[10px] font-bold ${
                        mentee.is_lateral_entry
                          ? 'bg-[#fbf5eb] dark:bg-[#1a2817] text-[#a16b15] dark:text-[#fbbf24] border border-[#a16b15]/30'
                          : 'bg-[#eef5ec] dark:bg-[#1a2817] text-[#385529] dark:text-[#4ade80] border border-[#385529]/30'
                      }`}>
                    ...
                    <td className="py-3.5 px-3 font-extrabold text-[#385529] dark:text-[#4ade80]">
                      {progress.totalApprovedPoints} pts
                    </td>
                    <td className="py-3.5 px-3 w-40">
                      <div className="flex items-center space-x-2">
                        <div className="w-full bg-[#e8e3d8] dark:bg-[#2b3d26] h-2 rounded-full overflow-hidden">
                          <div
                            className={`h-full rounded-full ${
                              progress.isCompleted ? 'bg-[#385529] dark:bg-[#4ade80]' : 'bg-[#a16b15] dark:bg-[#fbbf24]'
                            }`}
                    ...
                    <td className="py-3.5 px-3">
                      {progress.isCompleted ? (
                        <span className="inline-flex items-center text-[10px] font-bold text-[#385529] dark:text-[#4ade80] bg-[#eef5ec] dark:bg-[#1a2817] px-2 py-0.5 rounded-full border border-[#385529]/30">
                    ...
                    <td className="py-3.5 px-4 text-right">
                      <button
                        ...
                        className="px-2.5 py-1 bg-white dark:bg-[#1a2817] hover:bg-[#faf7f2] dark:hover:bg-[#22351e] text-[#385529] dark:text-[#4ade80] font-bold text-[11px] rounded-lg border border-[#e8e3d8] dark:border-[#2b3d26] transition-colors inline-flex items-center gap-1 cursor-pointer"
                        title="Download Official Activity Sheet"
                      >
                        <Download className="w-3 h-3 text-[#a16b15] dark:text-[#fbbf24]" />
                        <span>MAR Sheet</span>
                      </button>
                    </td>
                  </tr>
